...
全选框
//参考注册页面：
//1提交时，如果用户名重复（已有用户名用数组保存），阻止form提交，提示“用户名重复”。
//2重新输入用户名，一旦输入用户名部分没有重复，“用户名重复”的提示消失
//3当用户名或密码等有值时，关闭页面前弹出确认框
注册用户
//参考求助首页侧边栏“免费广告发布”弹出Modal，实现（不需要弹出Modal）：
//1根据下拉列表选中项，填充“文字内容”和“链接”文本框
//2勾选修改的checkbox，实现“文字内容”和“链接”文本框的禁用和启用
文本框
/*参考发布求助，实现其关键字功能：
没有选择一级关键字，不能选择二级关键字
